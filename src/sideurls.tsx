...
function getLeftLink(): BasicLeftLink[] {
  const Popular = new URL(location.href);

  Popular.searchParams.set('t', 'popular');
  ...
  return [
    ...
    new BasicLeftLink('Popular', Popular.toString(), <OcFlame2 />),
    new BasicLeftLink('Watch', '/?t=video', <OcDevices2 />),
    new BasicLeftLink('Help', '/help', <OcQuestion2 />),
  ];
}
